...
class Ui_Navigation(object):
    def setupUi(self, Navigation):
        ...
        self.localFavoriteButton = QToolButton(self.scrollAreaWidgetContents)
        self.buttonGroup = QButtonGroup(Navigation)
        self.buttonGroup.setObjectName(u"buttonGroup")
        self.buttonGroup.addButton(self.localFavoriteButton)
        self.localFavoriteButton.setObjectName(u"localFavoriteButton")
        sizePolicy1 = QSizePolicy(QSizePolicy.Expanding, QSizePolicy.Fixed)
        sizePolicy1.setHorizontalStretch(0)
        sizePolicy1.setVerticalStretch(0)
        sizePolicy1.setHeightForWidth(self.localFavoriteButton.sizePolicy().hasHeightForWidth())
        self.localFavoriteButton.setSizePolicy(sizePolicy1)
        self.localFavoriteButton.setMinimumSize(QSize(150, 0))
        self.localFavoriteButton.setFocusPolicy(Qt.NoFocus)
        icon = QIcon()
        icon.addFile(u":/images/menu/Contact.png", QSize(), QIcon.Normal, QIcon.Off)
        self.localFavoriteButton.setIcon(icon)
        self.localFavoriteButton.setIconSize(QSize(32, 32))
        self.localFavoriteButton.setCheckable(True)
        self.localFavoriteButton.setToolButtonStyle(Qt.ToolButtonTextBesideIcon)

        self.verticalLayout_3.addWidget(self.localFavoriteButton)
        ...
        self.batchSrButton.setMinimumSize(QSize(150, 0))
    ...
    def retranslateUi(self, Navigation):
        ...
        self.localFavoriteButton.setText(QCoreApplication.translate("Navigation", u"\u672c\u5730\u6536\u85cf", None))
